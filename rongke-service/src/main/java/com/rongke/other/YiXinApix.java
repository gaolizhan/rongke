...
public class YiXinApix {
    ...
    private static final String PARTNER_CODE = "t+t5toAkcABBJsA8HGLLEA==";// 合作方标识编码过的
    ...
    public static String zhimaScoreFirst(JSONObject jsonObject) throws IOException {
        ...
        String reqUrl = "http://skynet.eloanx.com/zm/score";
...
//        idNo--idName--mobileNo--idType
    ...
    public static final String PATH_CLASS_ROOT = YiXinApix.class.getClassLoader().getResource("").getPath();
    // 项目根路径
    ...
    public static void savePreLoanFile(String fileName, String content) {
        String path = ROOT_PATH + "/ATTACHMENT/preLoan/";
     ...
     * @throws IOException
     */
    public static String mxReport(String taskId) throws IOException {
        CloseableHttpClient client = HttpClients.createDefault();
//        String reqUrl = "https://www.mankoudai88.com/gateway/skynet/mx/report";
        String reqUrl = "http://skynet.eloanx.com/mx/report";
        HttpUriRequest request = RequestBuilder.get()//get请求
                .setUri(reqUrl)
                .addHeader("Content-type", "application/json;charset=UTF-8")
                .addParameter("message", taskId)//
                .addParameter("partner_code", PARTNER_CODE)
                .build();
        CloseableHttpResponse response = null;
        try {
            response = client.execute(request);
    ...
    public static void main(String[] args) throws IOException {
        ...
        jsonObject.put("idNo", "412724199803073712");
        jsonObject.put("idName", "王云鹏");
        jsonObject.put("mobileNo", "15168300680");
        jsonObject.put("idType", "1");

        String result = YiXinApix.preloan(jsonObject);
