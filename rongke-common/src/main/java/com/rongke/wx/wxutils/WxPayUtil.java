...
public class WxPayUtil {
    ...
    //微信支付key
    public static String API_KEY = "JMSY20170104YHJSKMMNGHmngbKhsa1a";
    //公众号appid
    public static String APPID = "wxde7966cb11f04742";
    //商户号id
    public static String MCH_ID = "1427068802";
    //证书路径
    public static String CERT_PATH = "/usr/local/tomcat/jumei";
