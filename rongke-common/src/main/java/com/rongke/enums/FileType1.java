...
public enum FileType1 {
    ...
    FileType1(String explain, String path) {
     ...
     * @return 绝对路径
     */
    public static String[] getPath(FileType1 fileType, int size, HttpServletRequest request) {
     ...
     * @return 路径地址
     */
    public static String genderPath(FileType1 fileType) {
     ...
     * @return 初始化后
     */
    public static FileType1 fileTypeInit(FileType1 fileType) {
        if (fileType == null) {
            fileType = FileType1.OTHER;
        }
        return fileType;
    }
}