...
public class JpushClientUtil {
    ...
    private final static String appKey = "1caff73bcf0ce33a3c807b7e";

    private final static String masterSecret = "59e4f5ec8ff80e33d66c33a8";
    ...
    public static int sendToAliasId(List<String> aliasList, String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_all_alias_alertWithTitle(aliasList,notification_title,msg_title,msg_content,extrasparam);
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAllIos(String notification_title, String content,String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_ios_all_alertWithTitle(notification_title,content,msg_title,msg_content,extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if(pushResult.getResponseCode()==200){
...
/*                .setNotification(Notification.newBuilder()
    ...
    private static PushPayload buildPushObject_ios_all_alertWithTitle( String notification_title, String content,String msg_title, String msg_content, String extrasparam) {
    ...
    public static void main(String[] args){
        ...
        list.add("21");
        if(JpushClientUtil.sendToAllAndroid("aa","测试推送","测试失败吗","")==1){
