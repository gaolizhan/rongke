package com.rongke.web.payutil.alipay.query;


import com.rongke.web.payutil.alipay.config.AlipayConfig;
import com.rongke.web.payutil.alipay.util.AlipayCore;
import com.rongke.web.payutil.alipay.util.httpClient.HttpProtocolHandler;
import com.rongke.web.payutil.alipay.util.httpClient.HttpRequest;
import com.rongke.web.payutil.alipay.util.httpClient.HttpResponse;
import com.rongke.web.payutil.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     */
    private static final String ALIPAY_GATEWAY_NEW = "https://mapi.util.com/gateway.do?";
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        return com.rongke.web.payutil.alipay.query.sign.MD5.sign(prestr, "", AlipayConfig.input_charset);
    }
