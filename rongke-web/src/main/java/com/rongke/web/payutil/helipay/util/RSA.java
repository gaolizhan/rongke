...
//            Security.addProvider(new BouncyCastleProvider());
    ...
    public static PrivateKey getPrivateKey2(String pfxPath, String pfxPassword) {
        try {
            BufferedReader br = new BufferedReader(new FileReader(pfxPath));
            ...
            byte[] buffer = Base64.decode(sb.toString().getBytes());
